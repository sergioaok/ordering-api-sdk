...
import { DriversGroups } from "../models/DriversGroups";
/**
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = "/drivergroups" +
                            (this.driversGroupsId ? "/" + this.driversGroupsId : "");
                        return [4 /*yield*/, this.makeRequest("GET", url, undefined, DriversGroups, options)];
                    case 1:
                        response = _a.sent();
