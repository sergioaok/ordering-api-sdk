...
var Ordering = /** @class */ (function () {
    ...
    Ordering.prototype.getRequestProps = function (options) {
         ...
         */
        var axiosOptions = __assign(__assign({}, otherOptions), { validateStatus: function (status) { return status < 500; }, params: _query || {}, headers: Object.assign(authHeaders, headers || {}) });
