            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        url = '/order_options';
                        return [4 /*yield*/, this.makeRequest('GET', url, undefined, OrderOption, options)];
                    case 1:
                        response = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        url = '/order_options';
                        return [4 /*yield*/, this.makeRequest('PUT', url, orderOption, OrderOption, options)];
                    case 1:
                        response = _b.sent();
